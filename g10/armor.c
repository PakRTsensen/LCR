...
static char *head_strings[] = {
    "BEGIN LCR MESSAGE",
    "BEGIN LCR PUBLIC KEY BLOCK",
    "BEGIN LCR SIGNATURE",
    "BEGIN LCR SIGNED MESSAGE",
    "BEGIN LCR ARMORED FILE",       /* gnupg extension */
    "BEGIN LCR PRIVATE KEY BLOCK",
    "BEGIN LCR SECRET KEY BLOCK",   /* only used by pgp2 */
    NULL
};
static char *tail_strings[] = {
    "END LCR MESSAGE",
    "END LCR PUBLIC KEY BLOCK",
    "END LCR SIGNATURE",
    "END dummy",
    "END LCR ARMORED FILE",
    "END LCR PRIVATE KEY BLOCK",
    "END LCR SECRET KEY BLOCK",
    NULL
};
